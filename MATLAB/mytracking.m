...
% foreground objects, and displaying results.
    ...
    function obj = setupSystemObjects()
        ...
        obj.reader = vision.VideoFileReader('video-1473216476.mp4');% Input video file name here
        ...
        obj.detector = vision.ForegroundDetector('NumGaussians', 3, ...
            'NumTrainingFrames', 50, 'MinimumBackgroundRatio', 0.1,'LearningRate',0.000001);
        ...
        obj.blobAnalyser = vision.BlobAnalysis('BoundingBoxOutputPort', true, ...
            'AreaOutputPort', true, 'CentroidOutputPort', true, 'LabelMatrixOutputPort', true , 'MinimumBlobArea', 2, 'ExtentOutputPort',true ,'MaximumCount', 3, ...
                  ...
                  displayposition5 = animatedline('color',[0.5 1 0]);
                   displayposition6 = animatedline('color',[1 1 0]);
                    displayposition7 = animatedline('color',[1 1 0.5]);
                     displayposition8 = animatedline('color',[1 0.5 0]);
                     displayposition9 = animatedline('color',[1 0 0]);
                        wholepos =[];
        ...
        if ~isempty(tracks)
            ...
            if ~isempty(reliableTracks)
               ...
               x = double(bboxes(:,1)+bboxes(:,3)/2);
                ...
                %fourth color 
                  if (trackage >= 1200 && trackage < 1599)
                  for ii=1:length(reliableTracks) 
                  addpoints(tracks(reliableTracks(ii).id).position4,x(ii),y(ii));
                  end
                  end
                  
                  if  (trackage >= 1600 && trackage < 1999)
                  ...
                  if  (trackage >= 2000 && trackage < 2399 )
                ...
                addpoints(tracks(reliableTracks(ii).id).position6,x(ii),y(ii));
                 ...
                 if  (trackage >= 2400 && trackage < 2699 )
                ...
                addpoints(tracks(reliableTracks(ii).id).position7,x(ii),y(ii));
                  ...
                  if  (trackage >= 2700 && trackage < 3199 )
                ...
                addpoints(tracks(reliableTracks(ii).id).position8,x(ii),y(ii));
                 ...
                 for  ii=1:length(reliableTracks) 
                addpoints(tracks(reliableTracks(ii).id).position9,x(ii),y(ii));
